...
const CertificateGenerator = () => {
  ...
  const participantMaps = {
    'Runners': new Map([['3241', 'Parth Doshi'],
      ...
      ['5024',{ name: 'Dr Pravin Pargaonkar', time: '' }],
      ...
      ['F5023',{ name: 'archana gandhi', time: '00:59:00' }],
        ...
        ['F5028',{ name: 'ranjankumar sharma', time: '' }],
        ['F5029',{ name: 'sanjaykumar sharma', time: '' }],
        ['F5030',{ name: 'rudra sharma', time: '' }],
        ['F5031',{ name: 'roma sharma', time: '' }],
        ['F5032',{ name: 'nilesh sharma', time: '' }],
        ['F5033',{ name: 'mayur mandale', time: '' }],
        ['F5077',{ name: 'grandsingh', time: '' }],
      ...
      ['', { name: 'Rajendrakumar Balasaheb', time: '' }],
      ...
      ['ankush',{ name: 'Ankush Lad', time: '' }],
      ['sagardahi',{ name: 'Sagar Dahiwale', time: '' }],
      ['shivkak',{ name: 'Shivshankar Kakade', time: '' }],
