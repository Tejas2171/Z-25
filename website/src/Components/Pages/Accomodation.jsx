                ...
                <div className="card-template textbox">
                    ...
                    <div className="card-info">
                        <ol className="list">
                            ...
                            <ol>
                                <li>Registration receipt <b>Accommodation Registration</b></li>
                            ...
                            <li>The deposit <b>Of all team members from all sports participated from his/her college</b> will not be refunded in the case of misconduct.</li>
                            ...
                            <li>Hostel gates open at 5:30 am and close at 11:30 pm <b>9:00 pm for girls</b></li>
                            ...
                            <li>COEP Technological University or the Zest'25 organizing team will not be responsible for any mishaps during the stay.</li>
                            <li>All the guidelines are subject to change and the final decision will be taken by the managing committee of ZEST'25.</li>
                        </ol>
                    </div>
                </div>
                <div className="card-template textbox">
                    ...
                    <div className="card-info">
                        <ol>
                            <li>The accommodation will be available from 12th January <b>9:00 am</b> to 14th January <b>5:00 pm</b> .For cricket, accommodation will be available as per the given dates for matches.</li>
                        ...
                        <ul>
                            ...
                            <div>
                                ...
                                /></p>
                                <p>If any of the Above Items are found to be missing in the given Room a fine of ₹500/- <b>per item missing</b> is charged .</p>
                            </div>
                            <br></br>
