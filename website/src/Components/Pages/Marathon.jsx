...
const Marathon = () => {
  ...
  return (
    <div className="">
      ...
      <button 
        type="button" 
        className="absolute z-50 right-10 lg:top-[20%] top-[90%] transform -translate-y-1/2 px-6 py-3 bg-transparent text-yellow-500 border-2 border-solid border-yellow-500 font-bold rounded-lg shadow-lg focus:outline-none focus:ring-0 hover:bg-yellow-800"
      ...
      >
        ...
        <div>
          <div className="coep-logo absolute z-40 top-24 left-4 w-32 lg:top-20 lg:left-10 lg:w-52 opacity-60">
            <img src="images/Coep logo white.png" />
          </div>
          <div className="line-logo absolute z-40 top-24 left-16 w-32 lg:top-24 lg:left-32 lg:w-48 opacity-60">
            <img src="images/line.png" />
          </div>
          <div className="fit-logo absolute z-40 top-28 left-36 w-24 lg:top-24 lg:left-64 lg:w-48 opacity-60">
